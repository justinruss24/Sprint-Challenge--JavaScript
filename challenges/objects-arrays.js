...
const lowCaseAnimalNames = zooAnimals.map(function(ani){
  return ani.animal_name.toLowerCase();
});
...
const lowPopulationAnimals = zooAnimals.filter(function (ani) {
...
*/
const populationTotal = zooAnimals.reduce(function(accum, pop){
